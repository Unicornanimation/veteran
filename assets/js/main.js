...
(function($) {
	...
	$('.box_1_img').mouseover(function () {
	      $('.box_1_contant').show();      
	});
	$('.box_1_img').mouseout(function () {
	      $('.box_1_contant').hide();      
	});

	$('.box_2_img').mouseover(function () {
	      $('.box_2_contant').show();      
	});
	$('.box_2_img').mouseout(function () {
	      $('.box_2_contant').hide();      
	});
	
	$('.box_3_img').mouseover(function () {
	      $('.box_3_contant').show();      
	});
	$('.box_3_img').mouseout(function () {
	      $('.box_3_contant').hide();      
	});
	
	$('.box_4_img').mouseover(function () {
	      $('.box_4_contant').show();      
	});
	$('.box_4_img').mouseout(function () {
	      $('.box_4_contant').hide();      
	});
	
	$('.box_5_img').mouseover(function () {
	      $('.box_5_contant').show();      
	});
	$('.box_5_img').mouseout(function () {
	      $('.box_5_contant').hide();      
	});
	
	$('.box_6_img').mouseover(function () {
	      $('.box_6_contant').show();      
	});
	$('.box_6_img').mouseout(function () {
	      $('.box_6_contant').hide();      
	});
	
	$('.box_7_img').mouseover(function () {
	      $('.box_7_contant').show();      
	});
	$('.box_7_img').mouseout(function () {
	      $('.box_7_contant').hide();      
	});
	
	$('.box_8_img').mouseover(function () {
	      $('.box_8_contant').show();      
	});
	$('.box_8_img').mouseout(function () {
	      $('.box_8_contant').hide();      
	});
	
	$('.box_9_img').mouseover(function () {
	      $('.box_9_contant').show();      
	});
	$('.box_9_img').mouseout(function () {
	      $('.box_9_contant').hide();      
	});
